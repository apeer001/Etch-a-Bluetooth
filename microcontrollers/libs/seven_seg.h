...
////////////////////////////////////////////////////////////////////////////////
//Functionality - returns output of 7-segment as unsigned char
//Parameter: An unsigned character to output
//Returns: unsigned char
unsigned char valOf7Seg(unsigned char c) {
	...
	switch (c) {
		case SS_0:
			sevenSegTemp =	(1<<sevenSeg_A)	|	(1<<sevenSeg_B) |	(1<<sevenSeg_C) |	(1<<sevenSeg_D) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_F)	;
			break;
		case SS_1:
			sevenSegTemp =	(1<<sevenSeg_B) |	(1<<sevenSeg_C) ;
			break;
		case SS_2:
			sevenSegTemp =	(1<<sevenSeg_A)	|	(1<<sevenSeg_B) |	(1<<sevenSeg_D) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_G) ;
			break;
		case SS_3:
			sevenSegTemp  =	(1<<sevenSeg_A)	|	(1<<sevenSeg_B) |	(1<<sevenSeg_C) |	(1<<sevenSeg_D) |
		...
		case SS_4:
			...
			break;
		case SS_5:
			sevenSegTemp  =	(1<<sevenSeg_A)	|	(1<<sevenSeg_C) |	(1<<sevenSeg_D) |
							(1<<sevenSeg_F) |	(1<<sevenSeg_G) ;
			break;
		case SS_6:
			sevenSegTemp  =	(1<<sevenSeg_A)	|	(1<<sevenSeg_C) |	(1<<sevenSeg_D) |
			...
			break;
		case SS_7:
			sevenSegTemp  =	(1<<sevenSeg_A)	|	(1<<sevenSeg_B) |	(1<<sevenSeg_C) ;
			break;
		case SS_8:
			sevenSegTemp  =	(1<<sevenSeg_A)	|	(1<<sevenSeg_B) |	(1<<sevenSeg_C) |	(1<<sevenSeg_D) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_F) |	(1<<sevenSeg_G) ;
		...
		case SS_A:
			...
			break;
		case SS_B:
			sevenSegTemp =	(1<<sevenSeg_C) |	(1<<sevenSeg_D) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_F) |	(1<<sevenSeg_G) ;
			break;
		case SS_C:
			sevenSegTemp  =	(1<<sevenSeg_A)	|	(1<<sevenSeg_D) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_F) ;
			break;
		case SS_D:
			sevenSegTemp  =	(1<<sevenSeg_B) |	(1<<sevenSeg_C) |	(1<<sevenSeg_D) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_G) ;
			break;
		case SS_E:
			sevenSegTemp  =	(1<<sevenSeg_A)	|	(1<<sevenSeg_D) |
			...
			break;
		case SS_F:
			sevenSegTemp  =	(1<<sevenSeg_A)	|
							(1<<sevenSeg_E)	|	(1<<sevenSeg_F) |	(1<<sevenSeg_G) ;
			break;
		case SS_DP:
			sevenSegTemp  =	(1<<sevenSeg_DP);
			break;
		case SS_G:
			sevenSegTemp  =	(1<<sevenSeg_A)	|	(1<<sevenSeg_C) |	(1<<sevenSeg_D) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_F) ;
		...
		case SS_H:
			...
			break;
		case SS_h:
			sevenSegTemp  =	(1<<sevenSeg_C) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_F) |	(1<<sevenSeg_G) ;
			break;
		case SS_I:
			sevenSegTemp  =	(1<<sevenSeg_E)	|	(1<<sevenSeg_F) ;
			break;
		case SS_J:
			sevenSegTemp  =	(1<<sevenSeg_B) |	(1<<sevenSeg_C) |	(1<<sevenSeg_D) |
							(1<<sevenSeg_E)	;
			break;
		case SS_L:
			sevenSegTemp  =	(1<<sevenSeg_D) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_F) ;
			break;
		case SS_m:
			sevenSegTemp  =	(1<<sevenSeg_A)	|	(1<<sevenSeg_C) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_G) ;
			break;
		case SS_N:
			sevenSegTemp  =	(1<<sevenSeg_A)	|	(1<<sevenSeg_B) |	(1<<sevenSeg_C) |
		...
		case SS_n:
			...
			break;
		case SS_P:
			sevenSegTemp =	(1<<sevenSeg_A)	|	(1<<sevenSeg_B) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_F) |	(1<<sevenSeg_G) ;
			break;
		case SS_R:
			sevenSegTemp =	(1<<sevenSeg_A)	|
			...
			break;
		case SS_r:
			sevenSegTemp  =	(1<<sevenSeg_E)	|	(1<<sevenSeg_G) ;
			break;
		case SS_t:
			sevenSegTemp  =	(1<<sevenSeg_D) |
							(1<<sevenSeg_E)	|	(1<<sevenSeg_F) |	(1<<sevenSeg_G) ;
		...
		case SS_u:
			...
			break;
		case SS_V:
			sevenSegTemp  =	(1<<sevenSeg_B) |	(1<<sevenSeg_D) |
							(1<<sevenSeg_F) ;
			break;
		case SS_v:
			sevenSegTemp  =	(1<<sevenSeg_B) |
							(1<<sevenSeg_F) |	(1<<sevenSeg_G) ;
			break;
		case SS_X:
			sevenSegTemp  =	(1<<sevenSeg_A)	|	(1<<sevenSeg_D) |
		...
		case SS_lambda:
			...
			break;
		case SS_char1:
			sevenSegTemp  =	(1<<sevenSeg_E)	|	(1<<sevenSeg_F) |	(1<<sevenSeg_G) ;
			break;
		case SS_char2:
			sevenSegTemp  =	(1<<sevenSeg_B) |	(1<<sevenSeg_C) |
							(1<<sevenSeg_G) ;
