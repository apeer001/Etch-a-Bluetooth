package com.apeer001.cs122a.cs122aproject.Bluetooth;

/**
 * Created by Aaron on 12/10/2015.
 */
/*
...
import com.apeer001.cs122a.cs122aproject.R;
...
//	}
    ...
    public void startDiscovery() {
        if (this.activity == null) {
            Log.d(getClass().getSimpleName(),  "you must first set an activity...");
            return;
        }
